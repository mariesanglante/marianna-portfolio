      ...
      <main id="main">
        ...
        <section id="cases" className="work wrap home-gallery" aria-labelledby="cases-title">
          ...
          <article className="project project-sema"><CaseCover slug="semaverse" name="Semaverse" tagline="Intelligence, connected" kind="desktop" src="/images/semaverse-vault.webp"/>
            <div className="project-copy"><div className="project-meta"><span>02 / SEMAVERSE</span><span>AI · B2B PLATFORM</span></div><h3>Intelligence,<br/>made legible.</h3><p>Making AI work understandable through connected research, visible progress, and document changes people can review and recover.</p><div className="role">Solo Product Designer · 2023–2026</div><Link className="pill-link" href="/cases/semaverse">View case study <Arrow /></Link></div>
          ...
          <article className="project project-oasive"><CaseCover slug="oasive" name="Oasive" tagline="Clarity in complexity" kind="desktop" src="/images/oasive/live-og.webp"/>
            ...
            <div className="project-copy"><div className="project-meta"><span>03 / OASIVE</span><span>FINTECH · WEBSITE</span></div><h3>A complex product.<br/>A clear introduction.</h3><p>Designing and refining the website for an AI fixed-income platform—from the product story and visual hierarchy to motion and responsive detail.</p><div className="role">UX/UI design · Motion · Responsive refinement</div><Link className="pill-link" href="/cases/oasive">View case study <Arrow /></Link></div>
          </article>
          <article className="project project-simcare"><CaseCover slug="simcare" name="SimCare" tagline="Practice with confidence" kind="desktop" src="/images/simcare/simulations-1.png"/><div className="project-copy"><div className="project-meta"><span>04 / SIMCARE</span><span>COUNSELING EDUCATION · WEBSITE</span></div><h3>A more human introduction<br/>to AI-powered practice.</h3><p>A connected website for simulations, field experience, course discovery, pricing, and support. Explore all five pages in an animated prototype.</p><div className="role">Website UX/UI · Product storytelling · Responsive design</div><Link className="pill-link" href="/cases/simcare">View case study <Arrow /></Link></div></article>
          <article className="project project-coinflix"><CaseCover slug="coinflix" name="Coinflix" tagline="Stories worth discovering" kind="phones" src="/images/coinflix/home.png" second="/images/coinflix/details.png"/><div className="project-copy"><div className="project-meta"><span>05 / COINFLIX</span><span>ENTERTAINMENT · MOBILE</span></div><h3>Short-form stories.<br/>A bigger role for creators.</h3><p>Designing a mobile entertainment platform that brings content discovery, community, and creator monetization together, from early research to the full app experience.</p><div className="role">Senior Product Designer · Research · Mobile UX/UI</div><Link className="pill-link" href="/cases/coinflix">View case study <Arrow /></Link></div></article>
          <article className="project project-causal"><CaseCover slug="causal-labs" name="Causal Labs" tagline="A clearer forecast" kind="desktop" src="/images/causal/temperature.png"/><div className="project-copy"><div className="project-meta"><span>06 / CAUSAL LABS</span><span>WEATHER INTELLIGENCE · AVIATION</span></div><h3>Weather signals.<br/>Operational context.</h3><p>Connecting weather events, affected airports, and prediction timing in one map-based experience. Explore the design decisions through an animated, interactive prototype.</p><div className="role">Interface design · Interaction flows · Prototyping</div><Link className="pill-link" href="/cases/causal-labs">View case study <Arrow /></Link></div></article>
          <article className="project project-ascy"><CaseCover slug="ascy" name="Ascy" tagline="From thought to action" kind="phones" src="/images/ascy/welcome.png" second="/images/ascy/home.png"/><div className="project-copy"><div className="project-meta"><span>07 / ASCY</span><span>VOICE-FIRST · MOBILE</span></div><h3>A thought.<br/>Already a note.</h3><p>A calm space for the things you don’t want to forget. From voice capture to editable notes and checklists, with a connected prototype of the main flows.</p><div className="role">Mobile UX/UI · Interaction design · Prototyping</div><Link className="pill-link" href="/cases/ascy">View case study <Arrow/></Link></div></article><article className="project project-rainforest"><CaseCover slug="rainforest" name="Rainforest" tagline="Energy at your fingertips" kind="phones" src="/images/rainforest/home.png" second="/images/rainforest/charging.png"/><div className="project-copy"><div className="project-meta"><span>08 / RAINFOREST</span><span>CONNECTED HOME · PRODUCT</span></div><h3>Making energy<br/>feel tangible.</h3><p>Connecting live demand, device controls, and everyday decisions. Explore the home-energy experience through a working, local prototype.</p><div className="role">Product UX/UI · Interaction design · Visual system</div><Link className="pill-link" href="/cases/rainforest">View case study <Arrow/></Link></div></article></div><div className="all-cases"><span>There’s more to explore.</span><Link href="/cases" className="all-cases-button">View all cases <span className="all-cases-arrow" aria-hidden="true">↗</span></Link><p>More products, experiments, and the thinking behind them.</p></div>
        </section>
