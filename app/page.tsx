const notion = 'https://mariesanglante.notion.site/';
      ...
      <main id="main">
        ...
        <section id="cases" className="work wrap" aria-labelledby="cases-title">
          ...
          <article className="project project-sema">
            <div className="project-copy"><div className="project-meta"><span>01 / SEMAVERSE</span><span>AI · B2B PLATFORM</span></div><h3>Clarity in a world<br/>of complex data.</h3><p>Redesigning an AI investment platform so people can navigate documents, understand system states, and work with confidence.</p><div className="role">Solo Product Designer · 2023–2026</div><a className="pill-link" href="https://www.semaverse.ai/" target="_blank" rel="noreferrer">Explore the product <Arrow /></a></div>
            <a className="project-visual sema-visual" href="https://www.semaverse.ai/" target="_blank" rel="noreferrer" aria-label="Explore Semaverse product"><span className="visual-label">SEMAVERSE / AI WORKSPACE</span><img src="/images/semaverse-vault.webp" alt="Semaverse AI Vault with document categories, processing progress, and an AI agent panel" width="2050" height="1460"/><span className="visual-footer">Complex workflows. Clear interactions.<span aria-hidden="true">↗</span></span></a>
          </article>
          <article className="project project-lumio">
            <a className="project-visual lumio-visual" href={`${notion}Product-Case-I-Lumio-Couples-Spending-JTBD-approach-05c2d903471a44279db10de6967bd975`} target="_blank" rel="noreferrer" aria-label="Read Lumio couples finances case study"><span className="lumio-logotype">lumio<span>®</span></span><img src="/images/lumio-phones.png" alt="Lumio mobile app showing a couple’s shared spending and recurring expenses" width="1080" height="1416" loading="lazy"/><span className="visual-caption">A little more together.</span></a>
            <div className="project-copy"><div className="project-meta"><span>02 / LUMIO</span><span>FINTECH · MOBILE</span></div><h3>Shared money.<br/>Individual lives.</h3><p>Helping Lumio evolve from automatic savings to couples’ finances. End-to-end design, grounded in 32 user interviews and built around how people actually share money.</p><div className="role">Sole Designer · Research to release</div><a className="pill-link" href={`${notion}Product-Case-I-Lumio-Couples-Spending-JTBD-approach-05c2d903471a44279db10de6967bd975`} target="_blank" rel="noreferrer">View case study <Arrow /></a></div>
          </article>
          <article className="project project-activation">
            <div className="project-copy"><div className="project-meta"><span>03 / LUMIO</span><span>ACTIVATION · EXPERIMENTATION</span></div><h3>Less friction.<br/>More first steps.</h3><p>Rethinking the journey to a couple’s first shared value. Using research and funnel analysis to make getting started feel worth it.</p><div className="role">Product strategy · UX · A/B testing</div><a className="pill-link" href={`${notion}Product-Case-II-Lumio-Activation-of-clients-f4bd988351144f61b1a5bdcdcfff8441`} target="_blank" rel="noreferrer">View case study <Arrow /></a></div>
            <a className="project-visual activation-visual" href={`${notion}Product-Case-II-Lumio-Activation-of-clients-f4bd988351144f61b1a5bdcdcfff8441`} target="_blank" rel="noreferrer" aria-label="Read Lumio activation case study"><div className="metric-heading">SMALLER STEPS. MEANINGFUL CHANGE.</div><div className="metric"><span>Partner invitations sent</span><strong>19<span>%</span><i>→</i>44<span>%</span></strong></div><div className="metric"><span>Bank accounts connected</span><strong>55<span>%</span><i>→</i>71<span>%</span></strong></div><div className="metric-note">Reported 30-day results · Variant A <Arrow /></div></a>
          </article>
          <div className="more-work"><span>More explorations, different challenges.</span><a href={`${notion}6876a45aacdf4ff99e69e203dc1fcfaf?v=c94420f9163f456f8890942599360bd2`} target="_blank" rel="noreferrer">Browse the case archive <Arrow /></a></div>
        </section>
        <section id="about" className="about wrap" aria-labelledby="about-title"><div className="section-heading"><h2 id="about-title">A little about me</h2><span>Kyiv, Ukraine · Working internationally</span></div><div className="about-grid"><h3>Curious about people.<br/>Serious about <span className="serif">craft.</span></h3><div><p>I’m a Ukrainian product designer with 10+ years in the digital industry, working across startups, agencies, and complex products.</p><p>I connect research, product thinking, and hands-on design. Alongside my practice, I teach UX and mobile interface design at Projector Institute.</p><a className="text-link" href="/Marianna-Gonchar-CV.pdf" target="_blank" rel="noreferrer">More about my experience <Arrow /></a></div></div></section>
      </main>
