...
const experience=[
 ...
 {company:'Semaverse',role:'Product Designer · Solo designer',date:'Sep 2023 — Jan 2026',location:'London · Remote',url:'https://www.semaverse.ai/',intro:'End-to-end product design for an AI investment platform, where complex data, document workflows, clarity and trust meet.',points:['Redesigned document uploading, saving, versioning and management, with explicit view, edit, processing and saved states.','Defined interactions with AI agents for analysing, interpreting and navigating investment documents and structured financial data.','Designed tables, forms and reusable interaction patterns; validated workflows through research and usability testing.','Worked closely with engineers on technical feasibility, predictable behaviour and edge cases.'],case:'/cases/semaverse'},
 {company:'Projector Institute',role:'UX Design & Mobile Interface Course Curator',date:'May 2023 — 2025',location:'Kyiv · Part-time',url:'https://prjctr.com/',intro:'Teaching and mentoring designers through practical projects, critique and real-world product thinking.',points:['Guide students through industry practices, complex concepts and hands-on design work.','Give individual feedback and constructive critique, encouraging independent problem-solving and collaboration.','Curate references and case studies to help students build their craft and prepare for professional practice.'],case:'/cases/projector'},
 {company:'Lumio',role:'Product Designer · Solo designer',date:'Jan 2022 — 2025',location:'London · Remote',url:'https://www.lumio-app.com/',intro:'Product design for a personal-finance app helping couples and families improve their financial health.',points:['Led research, market analysis, personas, use cases and user flows across web, iOS and Android.','Designed low- and high-fidelity wireframes and prototypes, ran live user testing, and worked with developers on implementation.','Built and maintained the design system, alongside graphic design and Webflow work.','Connected user feedback and product data with opportunities to improve activation and shared spending.'],case:'/cases/lumio-couples'},
 {company:'Webhub Software',role:'UI/UX Designer',date:'Feb 2021 — Dec 2021',location:'Kyiv · Full-time',url:'https://webhub.software/',intro:'Mobile and web product design for crypto and fintech applications.',points:['Worked from market analysis and user research through personas, flows, wireframes, prototypes and live testing.','Collaborated with the design team on interface craft, Agile delivery and design community building.']},
 {company:'Content.UA',role:'UI/UX Designer',date:'Feb 2020 — Feb 2021',location:'Kyiv · Part-time',url:'https://content.ua/',intro:'UX/UI and graphic design in a digital agency, with clients including Cisco, Winncom and ERC.',points:['Created and supported design systems and marketing materials across the project lifecycle.','Designed website and social-media elements, interfaces, vectors, icons and banners for digital and print.']},
